	...
	class FellowshipOne{
		...
		public static $paths = array(
			...
			'giving' => array(
				...
				'contributionSubTypes'=>'/giving/v1/contributiontypes/{typeID}/contributionsubtypes',
		...
		public function getGivingContributionSubTypes($typeID){
			return $this->getModel('giving','contributionSubTypes',array('typeID'=>$typeID));
		}
